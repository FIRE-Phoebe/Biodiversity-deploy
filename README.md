...
## Summary
In the Biodiversity Project, we provide interactive features to audience, which helps users to explore more information about Belly Button Biodiversity. Also, we successful automate different charts to share result foundings to audience. In addition, we customize the page to make it more attractive.
